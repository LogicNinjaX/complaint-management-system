...
import com.cms.complaint_management_system.exception.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({UserNotFoundException.class, DepartmentNotFoundException.class, ComplaintNotFoundException.class, CategoryNotFoundException.class})
    ...
    @ExceptionHandler({OfficerException.class, CitizenException.class, CategoryException.class, DepartmentException.class})
